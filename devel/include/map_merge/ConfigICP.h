// Generated by gencpp from file map_merge/ConfigICP.msg
// DO NOT EDIT!


#ifndef MAP_MERGE_MESSAGE_CONFIGICP_H
#define MAP_MERGE_MESSAGE_CONFIGICP_H
...
struct ConfigICP_
{
  ...
  typedef boost::shared_ptr< ::map_merge::ConfigICP_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::map_merge::ConfigICP_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigICP_

typedef ::map_merge::ConfigICP_<std::allocator<void> > ConfigICP;

typedef boost::shared_ptr< ::map_merge::ConfigICP > ConfigICPPtr;
typedef boost::shared_ptr< ::map_merge::ConfigICP const> ConfigICPConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::map_merge::ConfigICP_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::map_merge::ConfigICP_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::map_merge::ConfigICP_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::map_merge::ConfigICP_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::map_merge::ConfigICP_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::map_merge::ConfigICP_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::map_merge::ConfigICP_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::map_merge::ConfigICP_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::map_merge::ConfigICP_<ContainerAllocator> >
{
  ...
  static const char* value(const ::map_merge::ConfigICP_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5447e477cc209f1aULL;
  static const uint64_t static_value2 = 0xaba7597ea7741dc8ULL;
};

template<class ContainerAllocator>
struct DataType< ::map_merge::ConfigICP_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::map_merge::ConfigICP_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::map_merge::ConfigICP_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::map_merge::ConfigICP_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::map_merge::ConfigICP_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // MAP_MERGE_MESSAGE_CONFIGICP_H
